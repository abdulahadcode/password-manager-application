            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-900'>
                        ...
                        <b className='text-lg'>Save</b></button>
                </div>

                <div className="passwords w-[85vw] mx-auto">
                    <h2 className='font-bold text-2xl py-4 my-2'>Your Passwords</h2>
                    ...
                    {passwordArray.length != 0 && <table className="table-auto w-full rounded-md overflow-hidden mb-10">
                        ...
                        <tbody className='bg-green-100'>
                            {passwordArray.map((item, index) => {
                                return <tr key={index}>
                                    <td className='py-2 truncate max-w-[200px] border border-white text-center'>
                                    ...
                                    <td className='px-2 border truncate max-w-[150px] border-white text-center'>
                                        <div className='flex items-center justify-center gap-2 '>
                                    ...
                                    <td className='py-2 border truncate max-w-[150px] border-white text-center'>
                                        <div className='flex items-center justify-center gap-2'>
                                    ...
                                    <td className='flex justify-center truncate max-w-[80px] py-2 border border-white text-center'>
